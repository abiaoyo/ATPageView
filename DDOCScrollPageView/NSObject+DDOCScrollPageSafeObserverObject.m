//
//  NSObject+DDOCScrollPageSafeObserverObject.m
//  PA_zhima
//
...
@interface DDOCScrollPageSafeObserverObject : NSObject
...
@implementation DDOCScrollPageSafeObserverObject
...
@implementation NSObject (DDOCScrollPageSafeObserverObject)

- (DDOCScrollPageSafeObserverObject *)spsoo_safeObserver{
    return objc_getAssociatedObject(self, _cmd);
}

- (void)setSpsoo_safeObserver:(DDOCScrollPageSafeObserverObject *)spsoo_safeObserver{
    objc_setAssociatedObject(self, @selector(spsoo_safeObserver), spsoo_safeObserver, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}

- (DDOCScrollPageSafeObserverObject *)spsoo_currentSafeObserver{
    DDOCScrollPageSafeObserverObject * safeObserver = [self spsoo_safeObserver];
    if(!safeObserver){
        safeObserver = [DDOCScrollPageSafeObserverObject new];
...
- (void)spsoo_safeAddObserver:(NSObject *)observer
                   forKeyPath:(NSString *)keyPath
                      options:(NSKeyValueObservingOptions)options
{
    DDOCScrollPageSafeObserverObject * safeObserver = [self spsoo_currentSafeObserver];
