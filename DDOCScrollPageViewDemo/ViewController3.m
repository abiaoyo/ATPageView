...
@interface ViewController3 ()<DDOCScrollPageBarViewDelegate,DDOCScrollPageBarViewDataSource,DDOCScrollPageViewDataSource,DDOCScrollPageViewDelegate>
...
- (DDOCScrollPageBarView *)pageBarView{
    if(!_pageBarView){
        ...
        styleModel.style = DDOCScrollPageBarFixed;
